      ...
      <section className="section">
        ...
        <div className="head_card">
          <div className="team_card">
            <img src="./image/ben.jpg" alt="Ben" className="user_image" />
            <p className="user_name">Ben</p>
            <p className="user_designation">Director</p>
          ...
          <div className="team_card">
            <img src="./image/steve.jpg" alt="Steve" className="user_image" />
        ...
        <div className="employee_card">
          <div className="team_card">
            <img src="./image/hannah.jpg" alt="Hannah" className="user_image" />
            <p className="user_name">Hannah</p>
            <p className="user_designation">Web Developer</p>
            <p className="user_role">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit.
              Eligendi, veniam.
            </p>
          ...
          <div className="team_card">
            <img src="./image/dave.jpg" alt="Dave" className="user_image" />
            <p className="user_name">Dave</p>
            <p className="user_designation">Web Designer</p>
            <p className="user_role">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit.
              Eligendi, veniam.
            </p>
          ...
          <div className="team_card">
            ...
            <p className="user_designation">Graphic Desighner</p>
            <p className="user_role">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit.
              Eligendi, veniam.
            </p>
          ...
          <div className="team_card">
            ...
            <p className="user_designation">Video Editor</p>
            <p className="user_role">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit.
              Eligendi, veniam.
            </p>
